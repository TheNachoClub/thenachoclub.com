...
parse_args() {
    ...
    default_username=${GIT_DEPLOY_USERNAME:-rowbot-weisguy}
    default_email=${GIT_DEPLOY_EMAIL:-rowan.weismiller@gmail.com}

    #repository to deploy to. must be readable and writable.
    repo=${GIT_DEPLOY_REPO:-https://github.com/TheNachoCLub/thenachoclub.com.git}
